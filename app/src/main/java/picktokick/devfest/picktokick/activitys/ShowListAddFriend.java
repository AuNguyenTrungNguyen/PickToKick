...
import picktokick.devfest.picktokick.adapter.AdapterAddFriend;
import picktokick.devfest.picktokick.objects.Constanttt;
import picktokick.devfest.picktokick.objects.Friend;

public class ShowListAddFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_add_friend);

        data = FirebaseDatabase.getInstance().getReference();
        listAddFriend = findViewById(R.id.listAddFriend);

        friendList = new ArrayList<>();
        adapterAddFriend = new AdapterAddFriend(friendList, this);
    ...
    private void loadData() {
        ...
        data.child(Constanttt.USERS).child(myID).child("listWait").addChildEventListener(new ChildEventListener() {
            @Override
